            ...
            if (checkBox13.Checked)
            {
                foreach (TypeDef type in FileModule.Types)
                {
                    foreach (MethodDef method in type.Methods)
                    {
                        ...
                        if (method.Name == ".ctor")
                        {
                            FileModule.GlobalType.Remove(method);
                            break;
                        }
                    }
                }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (checkBox1.Checked || checkBox2.Checked || checkBox5.Checked || checkBox6.Checked || checkBox7.Checked || checkBox8.Checked || checkBox10.Checked || checkBox11.Checked || checkBox13.Checked)
                    {
