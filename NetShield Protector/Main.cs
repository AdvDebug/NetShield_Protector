...
namespace NetShield_Protector
{
    public partial class Main : Form
    {
        ...
        private void ObfuscasteCode(string ToProtect)
        {
            ...
            AssemblyDef AssemblyFile = AssemblyDef.Load(ToProtect, ModuleCont);
        ...
        private void USBPacking(string FileToPack, string Output)
        {
            ...
            string NewUSBPackerCode = USBPacker.Replace("DecME", Final).Replace("THISISIV", RandomIV).Replace("USBPacker", "namespace " + RandomName(14)).Replace("USBSADASAS", HashingHardwareID(comboBox1.Text));
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                else
                {
                    ...
                    if (checkBox1.Checked || checkBox2.Checked || checkBox5.Checked || checkBox6.Checked || checkBox7.Checked || checkBox8.Checked)
                    {
